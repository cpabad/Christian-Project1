...
## Headline
The service layer (`com.revature.service`) has **99.48% instruction coverage**
(1328 / 1335 instructions), measured with JaCoCo across a suite of **132 passing tests**.
...
unit tests exercise business logic in isolation. The 99.48% figure is the service (unit) layer.
...
both ways: the suite passes at the current 99.48%, and temporarily raising the minimum above it
