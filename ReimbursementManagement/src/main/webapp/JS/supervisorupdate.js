...
function updateUserInfo(){
    ...
    let url = '/ReimbursementManagement/app/manager/update-user-information?oldusername=' + oldusername + '&newusername=' + newusername + '&oldpassword=' + oldpassword + '&newpassword=' + newpassword + '&oldemail=' + oldemail + '&newemail=' + newemail + '&confirmusername=' + confirmusername + '&confirmpassword=' + confirmpassword + '&confirmemail=' + confirmemail
    let xhr = new XMLHttpRequest()
    xhr.onreadystatechange = function(){
        if(xhr.status === 200 && xhr.readyState === 4){
