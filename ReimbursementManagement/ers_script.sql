...
INSERT INTO users values(DEFAULT, 'admin', '$2a$10$2iPzYhJRQBBn73K38IeyAuFDOJC5QPk/qjnhTPE1tPtJ9aEtUARSq', 'A', 'A', 'a@email.com', 1);
INSERT INTO users values(DEFAULT, 'employee1', '$2a$10$AcxFYGGpzKK3pYbEX66hUeJcq4sK31W7t8JCkzE9G8Puie3w.9KHy', 'B', 'B', 'b@email.com', 1);
INSERT INTO users values(DEFAULT, 'employee2', '$2a$10$l.O.YdrDGKRrZUK9ODDK2OjyCmQLQV9yvTWdTV8FNoo3r5wmbL.ca', 'C', 'C', 'c@email.com', 2);
INSERT INTO users values(DEFAULT, 'employee3', '$2a$10$7gSd84zDIQQ5Z4ht3bCzIOCdNalXRtMhCO80a8m9JtfwP20fv8HAC', 'D', 'D', 'd@email.com', 2);
INSERT INTO users values(DEFAULT, 'employee4', '$2a$10$ZeextRWPH2z8A1Pv2WKrHe4SWr0SSFgeElLePgMRq7Pgp65u5ReW2', 'E', 'E', 'e@email.com', 2);
