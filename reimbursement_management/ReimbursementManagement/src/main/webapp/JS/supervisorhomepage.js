...
function goToUpdateUser(){
    ...
    xhr.open('GET', 'http://localhost:8080/ReimbursementManagement/supervisoreupdate.html')
    xhr.send()
}
...
let viewUserButton = document.getElementById('viewAllEmployeesManagers')
viewUserButton.addEventListener('click', viewemployeemanager)